...
void SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_init_function(
...
void SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_fini_function(void * message_memory)
{
  lll_rdm_msgs__msg__SignalHealthMetricMsgData__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_member_array[12] = {
  {
    "timeout",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_members = {
  ...
  SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_member_array,  // message members
  SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_init_function,  // function to initialize message memory (memory has to be allocated)
  SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_type_support_handle = {
  0,
  &SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lll_rdm_msgs, msg, SignalHealthMetricMsgData)() {
  if (!SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_type_support_handle.typesupport_identifier) {
    SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SignalHealthMetricMsgData__rosidl_typesupport_introspection_c__SignalHealthMetricMsgData_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
