...
#ifndef LLL_RDM_MSGS__MSG__SYSTEMS_HEALTH_METRIC_MSG_H_
#define LLL_RDM_MSGS__MSG__SYSTEMS_HEALTH_METRIC_MSG_H_
...
#endif  // LLL_RDM_MSGS__MSG__SYSTEMS_HEALTH_METRIC_MSG_H_
