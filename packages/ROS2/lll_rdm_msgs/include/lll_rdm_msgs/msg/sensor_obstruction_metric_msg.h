...
#ifndef LLL_RDM_MSGS__MSG__SENSOR_OBSTRUCTION_METRIC_MSG_H_
#define LLL_RDM_MSGS__MSG__SENSOR_OBSTRUCTION_METRIC_MSG_H_
...
#endif  // LLL_RDM_MSGS__MSG__SENSOR_OBSTRUCTION_METRIC_MSG_H_
