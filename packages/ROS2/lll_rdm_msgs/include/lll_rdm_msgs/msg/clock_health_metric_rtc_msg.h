...
#ifndef LLL_RDM_MSGS__MSG__CLOCK_HEALTH_METRIC_RTC_MSG_H_
#define LLL_RDM_MSGS__MSG__CLOCK_HEALTH_METRIC_RTC_MSG_H_
...
#endif  // LLL_RDM_MSGS__MSG__CLOCK_HEALTH_METRIC_RTC_MSG_H_
