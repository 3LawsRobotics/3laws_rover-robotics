...
#ifndef LLL_RDM_MSGS__MSG__CONTROL_TRACKING_METRIC_HIGH_FREQUENCY_MSG_H_
#define LLL_RDM_MSGS__MSG__CONTROL_TRACKING_METRIC_HIGH_FREQUENCY_MSG_H_
...
#endif  // LLL_RDM_MSGS__MSG__CONTROL_TRACKING_METRIC_HIGH_FREQUENCY_MSG_H_
