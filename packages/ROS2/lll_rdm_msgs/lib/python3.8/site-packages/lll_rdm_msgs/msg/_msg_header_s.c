...
bool lll_rdm_msgs__msg__msg_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._msg_header.MsgHeader", full_classname_dest, 38) == 0);
  }
  lll_rdm_msgs__msg__MsgHeader * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of MsgHeader */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._msg_header");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MsgHeader");
