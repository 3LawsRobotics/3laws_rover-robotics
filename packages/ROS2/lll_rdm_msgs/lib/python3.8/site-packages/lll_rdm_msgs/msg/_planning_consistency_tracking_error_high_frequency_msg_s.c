...
bool lll_rdm_msgs__msg__planning_consistency_tracking_error_high_frequency_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._planning_consistency_tracking_error_high_frequency_msg.PlanningConsistencyTrackingErrorHighFrequencyMsg", full_classname_dest, 121) == 0);
  }
  lll_rdm_msgs__msg__PlanningConsistencyTrackingErrorHighFrequencyMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // data
    ...
    if (!lll_rdm_msgs__msg__planning_consistency_tracking_error_high_frequency_msg_data__convert_from_py(field, &ros_message->data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PlanningConsistencyTrackingErrorHighFrequencyMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._planning_consistency_tracking_error_high_frequency_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanningConsistencyTrackingErrorHighFrequencyMsg");
  ...
  {  // data
    PyObject * field = NULL;
    field = lll_rdm_msgs__msg__planning_consistency_tracking_error_high_frequency_msg_data__convert_to_py(&ros_message->data);
    if (!field) {
      return NULL;
    }
    {
