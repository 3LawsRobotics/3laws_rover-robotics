...
bool lll_rdm_msgs__msg__metric_tags_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._metric_tags_msg_data.MetricTagsMsgData", full_classname_dest, 56) == 0);
  }
  lll_rdm_msgs__msg__MetricTagsMsgData * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of MetricTagsMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._metric_tags_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MetricTagsMsgData");
