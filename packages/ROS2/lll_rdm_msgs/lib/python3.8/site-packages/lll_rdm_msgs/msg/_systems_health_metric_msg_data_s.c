...
bool lll_rdm_msgs__msg__systems_health_metric_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._systems_health_metric_msg_data.SystemsHealthMetricMsgData", full_classname_dest, 75) == 0);
  }
  lll_rdm_msgs__msg__SystemsHealthMetricMsgData * ros_message = _ros_message;
  {  // timeout
  ...
  {  // values
    ...
    if (!lll_rdm_msgs__msg__system_resources_input_msg_data__convert_from_py(field, &ros_message->values)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SystemsHealthMetricMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._systems_health_metric_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SystemsHealthMetricMsgData");
  ...
  {  // values
    PyObject * field = NULL;
    field = lll_rdm_msgs__msg__system_resources_input_msg_data__convert_to_py(&ros_message->values);
    if (!field) {
      return NULL;
    }
    {
