...
bool lll_rdm_msgs__msg__node_health_metric_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._node_health_metric_msg.NodeHealthMetricMsg", full_classname_dest, 60) == 0);
  }
  lll_rdm_msgs__msg__NodeHealthMetricMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // data
    ...
    if (!lll_rdm_msgs__msg__node_health_metric_msg_data__convert_from_py(field, &ros_message->data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of NodeHealthMetricMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._node_health_metric_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodeHealthMetricMsg");
  ...
  {  // data
    PyObject * field = NULL;
    field = lll_rdm_msgs__msg__node_health_metric_msg_data__convert_to_py(&ros_message->data);
    if (!field) {
      return NULL;
    }
    {
