...
bool lll_rdm_msgs__msg__obstacles_distance_metric_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._obstacles_distance_metric_msg_data.ObstaclesDistanceMetricMsgData", full_classname_dest, 83) == 0);
  }
  lll_rdm_msgs__msg__ObstaclesDistanceMetricMsgData * ros_message = _ros_message;
  {  // timeout
  ...
  {  // min_dist_sensor_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "min_dist_sensor_id");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->min_dist_sensor_id, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of ObstaclesDistanceMetricMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._obstacles_distance_metric_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObstaclesDistanceMetricMsgData");
  ...
  {  // min_dist_sensor_id
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->min_dist_sensor_id.data,
      strlen(ros_message->min_dist_sensor_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "min_dist_sensor_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
