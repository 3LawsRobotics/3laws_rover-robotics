...
bool lll_rdm_msgs__msg__metric_passthrough_metric_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._metric_passthrough_metric_msg_data.MetricPassthroughMetricMsgData", full_classname_dest, 83) == 0);
  }
  lll_rdm_msgs__msg__MetricPassthroughMetricMsgData * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of MetricPassthroughMetricMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._metric_passthrough_metric_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MetricPassthroughMetricMsgData");
