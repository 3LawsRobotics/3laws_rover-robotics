...
bool lll_rdm_msgs__msg__clock_health_metric_rtc_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._clock_health_metric_rtc_msg_data.ClockHealthMetricRtcMsgData", full_classname_dest, 78) == 0);
  }
  lll_rdm_msgs__msg__ClockHealthMetricRtcMsgData * ros_message = _ros_message;
  {  // timeout
  ...
  {  // offset_from_rtc
    PyObject * field = PyObject_GetAttrString(_pymsg, "offset_from_rtc");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->offset_from_rtc = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of ClockHealthMetricRtcMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._clock_health_metric_rtc_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ClockHealthMetricRtcMsgData");
  ...
  {  // offset_from_rtc
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->offset_from_rtc);
    {
      int rc = PyObject_SetAttrString(_pymessage, "offset_from_rtc", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
