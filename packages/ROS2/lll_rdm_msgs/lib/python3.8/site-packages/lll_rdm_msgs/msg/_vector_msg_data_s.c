...
bool lll_rdm_msgs__msg__vector_msg_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_rdm_msgs.msg._vector_msg_data.VectorMsgData", full_classname_dest, 47) == 0);
  }
  lll_rdm_msgs__msg__VectorMsgData * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of VectorMsgData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_rdm_msgs.msg._vector_msg_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VectorMsgData");
