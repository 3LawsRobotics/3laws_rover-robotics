...
bool lll_msgs__msg__float64_vector_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lll_msgs.msg._float64_vector_stamped.Float64VectorStamped", full_classname_dest, 57) == 0);
  }
  lll_msgs__msg__Float64VectorStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Float64VectorStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lll_msgs.msg._float64_vector_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Float64VectorStamped");
