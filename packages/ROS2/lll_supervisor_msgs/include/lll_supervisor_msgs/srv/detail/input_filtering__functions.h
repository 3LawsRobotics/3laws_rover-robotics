...
#ifndef LLL_SUPERVISOR_MSGS__SRV__DETAIL__INPUT_FILTERING__FUNCTIONS_H_
#define LLL_SUPERVISOR_MSGS__SRV__DETAIL__INPUT_FILTERING__FUNCTIONS_H_
...
/// Initialize srv/InputFiltering message.
/**
...
/// Finalize srv/InputFiltering message.
/**
...
/// Create srv/InputFiltering message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lll_supervisor_msgs__srv__InputFiltering_Request__init().
...
/// Destroy srv/InputFiltering message.
/**
 * It calls
 * lll_supervisor_msgs__srv__InputFiltering_Request__fini()
...
/// Check for srv/InputFiltering message equality.
/**
...
/// Copy a srv/InputFiltering message.
/**
...
/// Initialize array of srv/InputFiltering messages.
/**
...
/// Finalize array of srv/InputFiltering messages.
/**
 * It calls
 * lll_supervisor_msgs__srv__InputFiltering_Request__fini()
...
/// Create array of srv/InputFiltering messages.
/**
 * It allocates the memory for the array and calls
 * lll_supervisor_msgs__srv__InputFiltering_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/InputFiltering messages.
/**
 * It calls
 * lll_supervisor_msgs__srv__InputFiltering_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/InputFiltering message array equality.
/**
...
/// Copy an array of srv/InputFiltering messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lll_supervisor_msgs__srv__InputFiltering_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lll_supervisor_msgs
...
/**
 * It calls
 * lll_supervisor_msgs__srv__InputFiltering_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lll_supervisor_msgs
...
/**
 * It allocates the memory for the array and calls
 * lll_supervisor_msgs__srv__InputFiltering_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lll_supervisor_msgs
...
/**
 * It calls
 * lll_supervisor_msgs__srv__InputFiltering_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LLL_SUPERVISOR_MSGS__SRV__DETAIL__INPUT_FILTERING__FUNCTIONS_H_
